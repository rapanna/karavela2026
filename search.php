...
<main role="main" class="content content--subpage">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h1 class="title title--h1">Výsledky hledání: <?php echo esc_html( get_search_query() ); ?></h1>
      </div>
    </div>
    <div class="row recommended-trips">
      ...
      <?php endwhile; else : ?>
        <div class="col-sm-12"><p>Pro dotaz „<?php echo esc_html( get_search_query() ); ?>" nebyly nalezeny žádné výsledky.</p></div>
      <?php endif; ?>
    </div>
  </div>
</main>
