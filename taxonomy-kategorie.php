<?php
/**
 * Archiv taxonomie „kategorie" (země/oblasti, URL /zajezdy/{slug}/).
 * Vypisuje zájezdy v dané kategorii jako dlaždice s nejbližším termínem
 * a cenami – stejný styl jako homepage „Doporučujeme".
 */
...
<main role="main" class="content content--subpage">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h1 class="title title--h1"><?php single_term_title(); ?></h1>
        <?php $td = term_description(); if ( $td ) : ?>
          <div class="taxonomy-description" style="margin-bottom:1em;"><?php echo $td; ?></div>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="row recommended-trips">
      ...
      <?php endforeach; else : ?>
        <div class="col-sm-12"><p>V této kategorii nejsou žádné zájezdy.</p></div>
      <?php endif; ?>
    </div>
  </div>
</main>
